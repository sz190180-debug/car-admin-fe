...
export const useGlobSetting = (): Readonly<GlobConfig> => {
  const {
    ...
    VITE_GLOB_DOMAIN_WEB_URL,
    VITE_GLOB_APP_DOWNLOAD_URL,
    VITE_GLOB_PC_DOWNLOAD_URL,
  ...
  const glob: Readonly<GlobConfig> = {
    ...
    webUrl: VITE_GLOB_DOMAIN_WEB_URL,
    appUrl: VITE_GLOB_APP_DOWNLOAD_URL,
    pcUrl: VITE_GLOB_PC_DOWNLOAD_URL,
    ...
    //百度地图密钥
    baiduMapAk: VITE_GLOB_BAIDU_MAP_AK,
  };
