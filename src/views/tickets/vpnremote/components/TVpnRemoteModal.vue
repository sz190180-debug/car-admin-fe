<template>
  <j-modal :title="title" maxHeight="500px" :width="800" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <TVpnRemoteForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></TVpnRemoteForm>
   <template #footer>
...
<script lang="ts" setup>
  ...
  import TVpnRemoteForm from './TVpnRemoteForm.vue'
