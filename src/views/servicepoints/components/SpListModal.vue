<template>
  <j-modal :title="title" maxHeight="500px" :width="800" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <SpListForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></SpListForm>
    <template #footer>
...
import SpListForm from "@/views/servicepoints/components/SpListForm.vue";
