        ...
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol"
          ...
          <a-row>
            ...
            <a-col :span="24" v-if="disabled">
              <a-form-item label="车型名称" v-bind="validateInfos.deviceModelName"
                           id="TDeviceForm-deviceModelName"
            ...
            <a-col :span="24" v-if="disabled">
              <a-form-item label="到期时间" v-bind="validateInfos.activeEndTimeText"
            ...
            <a-col :span="24"
              ...
              <a-form-item label="到期时间" v-bind="validateInfos.activeEndTime"
...
import {saveOrUpdate} from '../../TDevice.api';
