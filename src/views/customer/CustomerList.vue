  ...
  <div>
    ...
    <BasicTable @register="registerTable">
      ...
      <template #tableTitle>
        ...
        <!--        &lt;!&ndash;        <j-upload-button type="primary" preIcon="ant-design:import-outlined" @click="onImportXls" v-auth="'system:user:import'">导入</j-upload-button>&ndash;&gt;-->
        <!--        <import-excel-progress :upload-url="getImportUrl" @success="reload"></import-excel-progress>-->
        <!--        <a-button type="primary" @click="openModal(true, {})" preIcon="ant-design:hdd-outlined"> 回收站</a-button>-->
        <!--        <a-dropdown v-if="selectedRowKeys.length > 0">-->
        <!--          <template #overlay>-->
        <!--            <a-menu>-->
        <!--              &lt;!&ndash;              <a-menu-item key="1" @click="batchHandleDelete">&ndash;&gt;-->
        <!--              &lt;!&ndash;                <Icon icon="ant-design:delete-outlined"></Icon>&ndash;&gt;-->
        <!--              &lt;!&ndash;                删除&ndash;&gt;-->
...
import {batchDeleteUser, frozenBatch, getExportUrl, getImportUrl} from './user.api';
import {usePermission} from '/@/hooks/web/usePermission';
import {useRoute} from "vue-router";
import {deleteOne, list} from "@/views/company/TCompany.api";
...
const {prefixCls, tableContext, onExportXls, onImportXls} = useListPage({
  ...
  tableProps: {
    ...
    beforeFetch: (params) => {
      params.companyType = UserTypeEnum.CLIENT.value
