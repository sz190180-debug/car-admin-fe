...
import {getRegisterCaptcha, userRegisterApi} from '/@/api/sys/user';
...
const formData = reactive({
  companyType: UserTypeEnum.CLIENT.value,
  companyName: '',
  address: '',
  phone: '',
  name: '',
...
async function registerHandleClick() {
  await formRef.value?.validate();
  formData.companyType = UserTypeEnum.CLIENT.value;
