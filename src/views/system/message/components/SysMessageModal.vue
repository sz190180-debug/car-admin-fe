    ...
    <template #title>
      <div class="sys-msg-modal-title">
        ...
        <div class="icon-right">
          <div class="icons">
            <a-popover placement="bottomRight" :overlayStyle="{ width: '400px' }" trigger="click"
              ...
              <template #content>
                <div>
                  ...
                  <span style="display: inline-block;">
                    <div v-if="searchParams.fromUser" class="selected-user">
                      ...
                      <span class="clear-user-icon"><close-outlined style="font-size: 12px"
                                                                    @click="clearSearchParamsUser"/></span>
                    </div>
                ...
                <div class="search-date">
                  ...
                  <div class="date-tags">
                    <div class="tags-container">
                      <div v-for="item in noticeTypeOption"
              ...
              <span v-if="conditionStr" class="anticon filtera">
                ...
                <span
                  style="font-size:12px;margin-left: 3px;position: relative;">{{ conditionStr }}</span>
                <span style="display: flex;margin:0 5px;">
                  <svg @click="clearAll" t="1715689724802" class="icon" viewBox="0 0 1024 1024"
                       version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10694" width="14"
                       height="14"><path
    ...
    <div class="sys-message-card">
      <a-tabs :activeKey="activeKey" center @tabClick="handleChangePanel" animated>
        ...
        <a-tab-pane tab="全部消息" key="all" forceRender>
          <sys-message-list :isLowApp="isLowApp" ref="allMessageRef" @close="hrefThenClose"
                            @detail="showDetailModal" @clear="clearAll" :messageCount="messageCount"
                            @closeModal="closeModal"/>
        </a-tab-pane>

        <!-- 标星 -->
        <a-tab-pane tab="标星消息" key="star" forceRender>
          <sys-message-list :isLowApp="isLowApp" ref="starMessageRef" star @close="hrefThenClose"
                            @detail="showDetailModal" @clear="clearAll" :messageCount="messageCount"
                            @closeModal="closeModal" :cancelStarAfterDel="true"/>
        </a-tab-pane>
      </a-tabs>
    </div>
  </BasicModal>

  <user-select-modal isRadioSelection :showButton="false" labelKey="realname" rowKey="username"
                     @register="regModal" @getSelectResult="getSelectedUser"></user-select-modal>
