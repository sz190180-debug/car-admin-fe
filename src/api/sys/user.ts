...
enum Api {
  ...
  getCaptcha = '/sys/sms',
  //忘记密码-发送短信验证码
  getChangePassCaptcha = '/sys/user/sendChangePasswordSms',
  //用户注册-发送短信验证码
  getRegisterCaptcha = '/sys/user/sendRegisterSms',
  //注册接口
  ...
  //修改密码 新
  smsChangePassword = '/sys/user/smsChangePassword',
  //第三方登录
  ...
  //企业用户注册
  userRegister = '/sys/user/register',
}
 ...
 */
export function getChangePassCaptcha(params) {
  return new Promise((resolve, reject) => {
    defHttp.post({
      url: Api.getChangePassCaptcha,
      params
...
/**
 * @description: 获取注册用户短信验证码
 */
export function getRegisterCaptcha(params) {
  return new Promise((resolve, reject) => {
    defHttp.post({
      url: Api.getRegisterCaptcha,
      params
    }, {isTransformResponse: false}).then((res) => {
      console.log(res);
      if (res.success) {
 ...
 * @param params
 */
export const phoneVerify = (params) => defHttp.post({
  url: Api.phoneVerify,
  params
}, {isTransformResponse: false});
/**
 ...
 * @param params
 */
export const smsChangePassword = (params) => defHttp.post({
  url: Api.smsChangePassword,
  params
}, {isTransformResponse: false});
...
export function userRegisterApi(params) {
  return defHttp.post({url: Api.userRegister, params}, {isReturnNativeResponse: true});
}
